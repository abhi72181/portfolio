		...
		<div className={styles.experiences}>
			...
			<div className={styles.container}>
				...
				Masai School  | Full Stack Web Developer (MERN){' '}
					<a href=''>  Learning Full Stack Developement (MERN) and Communication skills.</a>
				</div>
			...
			<div className={styles.container}>
				<div className={styles.position}>
				P.R.Pote College (Amravati) | Graduation{' '}
				<br />
					<a href='/'>  Electrical Engineering </a>
				</div>
				<div className={styles.date}>August 2016 - June 2020</div>
				{/* <fieldset className={styles.responsibilites}>
					<legend>
						<h3> Roles & responsibilites </h3>
					</legend>
